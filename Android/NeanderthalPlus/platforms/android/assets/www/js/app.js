var app = (function()
{
	...
	function displayBeaconList()
	{
		...
		else if (beacon.major == 40822 && beacon.minor == 1007 && beacon.distance < 3 && tour == 5) {
		...
		else if (beacon.major == 40822 && beacon.minor == 1011 && beacon.distance < 3 && tour == 5) {
			BeaconLink = "../rundgang/dauerausstellung09.html";
		}
		
		else if (beacon.major == 40822 && beacon.minor == 1012 && beacon.distance < 1 && tour == 5) {
			BeaconLink = "../rundgang/dauerausstellung10.html";
		}
		
		else if (beacon.major == 40822 && beacon.minor == 1013 && beacon.distance < 1 && tour == 5) {
			BeaconLink = "../rundgang/dauerausstellung10.html";
		}
		...
		else if (beacon.major == 40822 && beacon.minor == 1015 && beacon.distance < 2 && tour == 5) {
		...
		else if (beacon.major == 40822 && beacon.minor == 1012 && beacon.distance < 1 && tour == 6) {
			BeaconLink = "../rundgang/dauerausstellung_kinder10.html";
		}
		
		else if (beacon.major == 40822 && beacon.minor == 1013 && beacon.distance < 1 && tour == 6) {
			BeaconLink = "../rundgang/dauerausstellung_kinder10.html";
		}
		...
		else if (beacon.major == 40822 && beacon.minor == 1015 && beacon.distance < 2 && tour == 6) {
